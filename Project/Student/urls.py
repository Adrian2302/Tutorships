...
urlpatterns = [
     ...
     path('estudiante/tutoria/pendientes/<int:pk_request>', views.pendingRequests.as_view(), name='student_pending_request'),
     path('estudiante/tutoria/aceptadas/<int:pk_request>', views.acceptedRequests.as_view(), name='student_accepted_request'),
     path('estudiante/tutoria/rechazadas/<int:pk_request>', views.rejectedRequests.as_view(), name='student_rejected_request'),
     path('estudiante/tutoria/historial/<int:pk_request>', views.doneTutorships.as_view(), name='student_done_request')
]
